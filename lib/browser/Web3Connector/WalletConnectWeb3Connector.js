        ...
        return _regenerator.default.wrap(function (_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, providedChainId = _ref.chainId, mobileLinks = _ref.mobileLinks, newSession = _ref.newSession, speedyNodeApiKey = _ref.speedyNodeApiKey; // Log out of any previous sessions
                ...
                console.log('팀마파 WalletConnect...', speedyNodeApiKey, providedChainId, mobileLinks, newSession);
                config = {
                  rpc: speedyNodeApiKey ? (0, _MoralisRpcs.getMoralisRpcs)(speedyNodeApiKey) : (0, _MoralisRpcs.getMoralisRpcs)('WalletConnect'),
